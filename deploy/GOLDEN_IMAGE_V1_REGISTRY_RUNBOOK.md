...
```bash
docker build -f server/Dockerfile -t ghcr.io/walid733/express-trade-kit-api:v1.0.1 ./server
docker build -f Dockerfile.web -t ghcr.io/walid733/express-trade-kit-web:v1.0.1 .
```

إذا أردت وسمًا إضافيًا للإصدار الحالي:

```bash
docker tag ghcr.io/walid733/express-trade-kit-api:v1.0.1 ghcr.io/walid733/express-trade-kit-api:latest
docker tag ghcr.io/walid733/express-trade-kit-web:v1.0.1 ghcr.io/walid733/express-trade-kit-web:latest
```
...
docker push ghcr.io/walid733/express-trade-kit-api:v1.0.1
docker push ghcr.io/walid733/express-trade-kit-web:v1.0.1
