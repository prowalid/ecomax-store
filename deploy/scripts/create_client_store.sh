...
Options:
  ...
  --api-image       API image tag (default: ghcr.io/prowalid/ecomax-store-api:v1.0.27)
  --web-image       Web image tag (default: ghcr.io/prowalid/ecomax-store-web:v1.0.27)
...
API_IMAGE="ghcr.io/prowalid/ecomax-store-api:v1.0.27"
WEB_IMAGE="ghcr.io/prowalid/ecomax-store-web:v1.0.27"
POSTGRES_PASSWORD=""
JWT_SECRET=""
METRICS_TOKEN=""
START_STACK="false"
