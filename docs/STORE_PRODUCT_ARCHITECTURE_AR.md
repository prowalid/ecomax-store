...
- صفحات اكتشاف أوضح عبر:
  - `/shop`
  - `/category/:categorySlug`
- روابط منتجات مقروءة عبر `slug`

وما يزال مطلوبًا لاحقًا:

- تحسينات أعمق في `discovery`
- بحث/اقتراحات أغنى
- صفحات هبوط وتصنيف أقوى للنمو
...
- عرض مختصر لآخر التعديلات الإدارية داخل صفحة `Analytics`
...
- سجل أحداث مهم
- من غيّر ماذا ومتى
- تغطية أوسع لنفس فكرة `version/conflict` على بقية الموارد الإدارية إذا لزم
...
- جولة أوسع لاحقًا من `merchant UX` فوق ما أُنجز بالفعل
- تحسينات `discovery` أعمق من النسخة الحالية
